...
class Intro_Stage2(AbstractStage):
    def __init__(self, controller, window, sound, player, sprite, font, objects):
        self.control = controller
        self.name = "Intro_Stage2"
        self.sound = sound
        self.control = controller
        level_dimensions = (1280,720)
        super().__init__(player, window, "Intro_Stage2", level_dimensions)
        ...
        self.file_lines = [42, 43, 44, 45, 46, 47, 48]
    ...
    def update(self):
        while self.nextStageKey is "Intro_Stage2":
